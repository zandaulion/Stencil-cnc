...
|---|---|---|
| 1. Open or resume a project | Projects, thumbnails, recovery points, last-project reopening. The Projects surface now opens the device cache immediately and performs server reconciliation in the background. | Fast resumption should not require the entire library. Cache-first library navigation is implemented; metadata-first synchronization and on-demand asset retrieval remain K19 work. |
